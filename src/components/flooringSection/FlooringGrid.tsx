...
export const FlooringGrid: React.FC<FlooringGridProps> = ({ setSelectedFloor, setBgImage, setFadeOut }) => {
  ...
  const floors = [
    { key: "luxuryVinyl", label: "Luxury Vinyl", image: "https://res.cloudinary.com/drwacbtjf/image/upload/v1743508300/WhatsApp_Image_2025-03-31_at_23.10.44_ff4b6490_phzxzy.jpg", bgImage: "https://res.cloudinary.com/drwacbtjf/image/upload/v1744642268/vynil_sie1yd.jpg" },
